...
// 网站的根目录
const char* doc_root = "/home/zhangzs/code/cpp/nowcoder/webserver/resources";
...
// 修改文件描述符，重置socket上EPOLLINESHOT事件，以确保下一次可读时，EPOLLIN事件能够被触发
